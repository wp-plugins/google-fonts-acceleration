...
加速失败请先确认是否有启用其他同类插件导致互相冲突，有意见或者建议请邮件与我联系cqdaidong@gmail.com
...
=
1.6 =
* 由于总所周知的原因，我们在维护Google公共库加速的同时，新增了对Gravatar头像的加速。您无需再安装多个插件以及繁琐的修改主题文件本插件对WordPress性能的影响可忽略不计。

== Upgrade Notice ==

= 
1.6 =
* 在优化谷歌公共库加速的同时,新增对Gravatar头像的加速!（暂不支持SSL调用）